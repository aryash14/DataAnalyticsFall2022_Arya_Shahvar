...
m
matrix(m,nrow = 2)
matrix(1:12,byrow = FALSE,nrow = 4) #goes down the column
matrix(1:12,byrow = TRUE,nrow = 4) #goes to the row
...
stock.matrix #stock_matrix is also valid
